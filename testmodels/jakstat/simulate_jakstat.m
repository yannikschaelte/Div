...
if(options_ami.sensi<2)
    sol = ami_jakstat(tout,theta(1:17),kappa(1:2),options_ami,plist,xscale,init,data);
else
    sol = ami_jakstat_o2(tout,theta(1:17),kappa(1:2),options_ami,plist,xscale,init,data);
end
if(options_ami.sensi == 2)
