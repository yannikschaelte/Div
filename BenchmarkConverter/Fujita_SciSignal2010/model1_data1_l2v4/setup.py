...
sources = ['swig/model1_data1_l2v4.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_data1_l2v4/_model1_data1_l2v4',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_data1_l2v4',
...
# Install
setup(
    name='model1_data1_l2v4',
    version='0.1.0',
    description='AMICI-generated module for model model1_data1_l2v4',
